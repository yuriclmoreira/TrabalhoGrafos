...
class Agm{
    public:
        ...
        void saidaResultGuloso(string instancia, string out, double time);
        void saidaResultReativo(string instancia, string out, int sol, double time, int max, int bloco);
